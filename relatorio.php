                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <select class="form-select" id="teamNames" onchange="updateTeamNames(event)">
                            ...
                            <option value="Carlos Alberto Francisco de Araujo">Carlos Alberto Francisco de Araujo</option>
                            ...
                            <option value="Miguel Lessa Costa">Miguel Lessa Costa</option>
                            ...
                            <option value="Wallesoh Jorge Nunes">Wallesoh Jorge Nunes</option>
